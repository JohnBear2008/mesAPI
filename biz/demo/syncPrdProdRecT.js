...
//	    	console.log("connectionMES:"+JSON.stringify(connectionMES))
    ...
    var getsql="select b.Action,a.BillNO,a.ProdID from comprodrec a,(select PKValue,Action from comChangeLog where changetime>= DATEADD(minute,-5, GETDATE()+2) and ProgID='ChiProdt.TakeMat' ) b where a.BillNO=b.PKValue and a.Flag=332";
...
function ERPtoMES(){
	...
	yjDBService_sqlserver.exec({
        ...
        success : function(result) {
            ...
            console.log("get退料data:"+JSON.stringify(data));
            //插入mes-----------------
...
//           		console.log("CreateTime:"+JSON.stringify(CreateTime));
            		...
            		yjDBService.exec({
                        ...
                        sql: postsql,
                        parameters: ["ERP","comProdRec",data[i].BillNO,data[i].ProdID,"332","API","0",SynchType,CreateTime],
                        success: function(result) {
                        	console.log("退料插入成功!")
                        },
                        error: {}
