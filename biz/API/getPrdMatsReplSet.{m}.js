...
//  console.log("connectionOptions:"+JSON.stringify(connectionOptions));
    ...
    var MainProdID=sender.req.query.MainProdID;
    console.log("getinfo:"+JSON.stringify(getinfo));
    
  
    console.log("数据类型:"+typeof(MainProdID));
    
    if(typeof(MainProdID)=="string"){
    	var sql="select MainProdID,ReplaceType,PRI,ReplProdID,InvalidDate from prdMatsReplSet Where MainProdID =?";
    }
    
//    if(typeof(MainProdID)=="object"){
//
//    	  var sql="select * from prdMKOrdMain Where MainProdID in('333','444') ";
//    }
//    
