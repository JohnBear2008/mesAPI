...
//	    	console.log("connectionMES:"+JSON.stringify(connectionMES))
    ...
    var getsql=" select a.ProductID,b.Action from prdBOMMain a,(select  PKValue,Action from comChangeLog where   changetime>= DATEADD(minute,-5, GETDATE()+2)  and ProgID='CHIProdt.BOM')b where a.ProductID=b.PKValue";
