...
//	    	console.log("connectionMES:"+JSON.stringify(connectionMES))
    ...
    var getsql="select a.varyid,b.Action from prdVaryMain a,(select  PKValue,Action from comChangeLog where   changetime>= DATEADD(minute,-5, GETDATE()+2)  and ProgID='CHIProdt.VaryBom')b where a.varyid=b.PKValue";
